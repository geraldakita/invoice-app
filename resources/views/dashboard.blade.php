                    ...
                    <div class="border rounded-lg overflow-hidden dark:border-gray-700">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-transparent">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($lastFiveInvoices as $invoice)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">$invoice->customer_name</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">$invoice->invoice_number</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">$invoice->customer_address</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">$invoice->status</td>
                                ...
                                <tr class="bg-white hover:bg-gray-100 dark:bg-slate-900 dark:hover:bg-slate-800">
                                    <td colspan="5" class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-600 dark:text-gray-400">
